...
% FUENTE
% \setmainfont[BoldFont=fonts/arialbd.ttf,
% ItalicFont=fonts/ariali.ttf,
% BoldItalicFont=fonts/arialbi.ttf]{fonts/Arial.ttf}
...
\doublespacing % Espaciado de 1.5 líneas
...
\rhead{
    \begin{tikzpicture}[overlay, fill]
        \node[] at (-0.2, 0.4) 
    {\includegraphics[width=0.8cm,height=1cm]{./figuras/marca_agua.png}};
    \end{tikzpicture} 
}
...
% SECCIÓN 1
%%%%%%%%%%%%%%
\input{secciones/cuerpo/seccion1.tex}

%%%%%%%%%%%%%% 
% SECCIÓN 2
%%%%%%%%%%%%%%

\input{secciones/cuerpo/seccion2.tex}


%%%%%%%%%%%%%% 
% SECCIÓN 3
%%%%%%%%%%%%%%
\input{secciones/cuerpo/seccion3.tex}
%%%%%%%%%%%%%% 
% SECCIÓN 4
%%%%%%%%%%%%%%
\input{secciones/cuerpo/seccion4.tex}
